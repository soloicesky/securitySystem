...
char *RemoveCharInString(char *str,char ch);


char *ReplaceCharInString(char *str, char ch, char replaceCh);


int fillStringLeftPadWithChar(char *desStr, char *src, int fillLen,char ch);


int fillStringRightPadWithChar(char *desStr, char *src, int fillLen,char ch);

char *stringTrimLeft(char *str);

char *stringTrimRight(char *str);
